...
public class XbonacciTest {
    ...
    public void basicTests() {
        assertArrayEquals(new double []{0,1,1,2,3,5}, variabonacci.xbonacci(new double []{0,1},6));
        ...
        assertArrayEquals(new double []{1,0,0,0,0,0,1,2,3,6}, variabonacci.xbonacci(new double []{1,0,0,0,0,0,1},4));
    }
